<x-layout.layout-web>
    <div class="md:flex md:justify-center md:w-[60%] md:mx-auto mt-5">
        ...
        <div class="p-1">
            <x-category-card title="Materas"
                imgUrl="https://acdn.mitiendanube.com/stores/001/262/665/products/photoroom-20231110_093715_5-207f58965f72fbe890169962069373031-65631a8689a940696d16996214740466-640-0.webp"></x-category-card>
        </div>
    </div>
</x-layout.layout-web>
