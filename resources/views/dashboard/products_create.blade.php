        ...
        <div class="md:w-[40%] p-5 mx-auto mt-5">
            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="flex flex-col align-middle md:mr-1">
                    <label for="available"
                        class=" font-semibold text-sm bg-lightZinc focus:bg-white text-black py-2">Disponible</label>
                ...
                <div class="flex flex-col justify-start">
                    ...
                    <textarea name="description" id="" cols="20" rows="5" style="resize:none"
                        class="text-sm  text-black bg-lightZinc focus:bg-white font-light px-3 py-2 border-0 border-b-2 focus:outline-none focus:border-b-lightBlue focus:ring-0">{{ old('description') }}</textarea>
                </div>
                <div class="flex flex-col justify-start md:mr-1">
